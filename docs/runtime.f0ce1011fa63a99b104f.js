  ...
  (a.m = v),
    ...
    (a.O = (n, r, c, l) => {
      if (!r) {
        ...
        for (t = 0; t < e.length; t++) {
          for (var [r, c, l] = e[t], u = !0, f = 0; f < r.length; f++)
            (!1 & l || s >= l) && Object.keys(a.O).every((i) => a.O[i](r[f]))
              ? r.splice(f--, 1)
              : ((u = !1), l < s && (s = l));
          if (u) {
            e.splice(t--, 1);
    ...
    (() => {
      ...
      var n = (c, l) => {
          ...
          if (u) var h = u(a);
          for (c && c(l); _ < t.length; _++)
            a.o(e, (o = t[_])) && e[o] && e[o][0](), (e[t[_]] = 0);
          return a.O(h);
        },
        r = (self.webpackChunkdog_memory_game =
          self.webpackChunkdog_memory_game || []);
